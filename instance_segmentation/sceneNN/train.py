...
ADE20K_MODEL_PATH = os.path.join(
    ROOT_DIR, 'logs/seg_ade20k20171109T1726/mask_rcnn_seg_ade20k_0018.h5')
WEIGHTS_PATH = os.path.join(
    ROOT_DIR,
    'logs/seg_scenenn20171109T1726/mask_rcnn_seg_scenenn_0153.h5')
